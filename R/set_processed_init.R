...
set_processed_init_new <- function(data, mh_setup_lst, init_lst, prior_lst, 
                               chain_setup_lst_1, chain_setup_lst_2, verbose){
  
  init_processed <- init_lst
  res <- glvcausal_free_L(data, mh_setup_lst, init_processed, prior_lst, chain_setup_lst_1, verbose)
  init_processed <- update_init_wo_UGLT_new(init_processed, res, prior_lst)
  init_processed <- glvcausal_only_UGLT(data, mh_setup_lst, init_processed, prior_lst, chain_setup_lst_2, verbose)
...
set_processed_init_t <- function(data, mh_setup_lst, init_lst, prior_lst, 
                               chain_setup_lst_1, chain_setup_lst_2, verbose){
  
  init_processed <- init_lst
  res <- glvcausal_free_L_t(data, mh_setup_lst, init_processed, prior_lst, chain_setup_lst_1, verbose)
  init_processed <- update_init_wo_UGLT_t(init_processed, res, prior_lst)
  init_processed <- glvcausal_only_UGLT_t(data, mh_setup_lst, init_processed, prior_lst, chain_setup_lst_2, verbose)
...
set_processed_init_uni <- function(data, mh_setup_lst, init_lst, prior_lst,
                                   chain_setup_lst_1, chain_setup_lst_2, verbose){
  
  init_processed <- init_lst
  res <- glvcausal_uni_L(data, mh_setup_lst, init_processed, prior_lst, chain_setup_lst_1, verbose)
  init_processed <- update_init_wo_UGLT_uni(init_processed, res, prior_lst)
  init_processed <- glvcausal_only_UGLT(data, mh_setup_lst, init_processed, prior_lst, chain_setup_lst_2, verbose)
...
update_init_wo_UGLT_new <- function(init_lst, res, prior_lst){
...
update_init_wo_UGLT_t <- function(init_lst, res, prior_lst){
  ...
  init_lst$nu_alpha <- extract_post_mean(res, "nu_alpha", init_lst$P_star)
  init_lst$rho_alpha <- extract_post_mean(res, "rho_alpha", init_lst$P_star)
  A_tmp <- extract_post_mean(res, "A", init_lst$P_star)
  init_lst$A <- A_tmp * gamma_alpha_tmp
...
update_init_wo_UGLT_uni <- function(init_lst, res, prior_lst){
  ...
  init_lst$nu_alpha <- extract_post_mean(res, "nu_alpha", init_lst$P_star)
  init_lst$rho_alpha <- extract_post_mean(res, "rho_alpha", init_lst$P_star)
  init_lst$A <- extract_post_mean(res, "A", init_lst$P_star)
  ...
  init_lst$nu_beta <- extract_post_mean(res, "nu_beta", init_lst$P_star)
  init_lst$rho_beta <- extract_post_mean(res, "rho_beta", init_lst$P_star)
  init_lst$B <- extract_post_mean(res, "B", init_lst$P_star)
