glvcausal_free_L_t <- function(data, mh_setup_lst, init_lst, prior_lst, chain_setup_lst, verbose){
  ...
  if(is.null(prior_lst$nu_t)) stop("prior_lst$nu_t is required for glvcausal_free_L_t")
  ...
  for(it in 2:chain_setup_lst$Nit){
    ...
    param_all_lst$A <- update_A_rcpp(param_all_lst$gamma_alpha, param_all_lst$nu_alpha, param_all_lst$B, param_all_lst$L_free, param_all_lst$C_free, param_all_lst$mu, param_all_lst$tau, param_all_lst$sigma2, data$Y, data$X)
    ...
    # Use update_B_t for Student-t
    param_all_lst$B <- update_B_t(param_all_lst$B, param_all_lst$gamma_beta, param_all_lst$nu_beta, param_all_lst$A, param_all_lst$mu, param_all_lst$L_free, param_all_lst$C_free, param_all_lst$sigma2, mh_setup_lst$B_step, data, prior_lst$nu_t)
    ...
    # Use update_tau_t_rcpp for Student-t
    param_all_lst$tau <- update_tau_t_rcpp(param_all_lst$B, param_all_lst$A, param_all_lst$L_free, param_all_lst$C_free, param_all_lst$mu, param_all_lst$sigma2, data$Y, data$X, prior_lst$nu_t)
